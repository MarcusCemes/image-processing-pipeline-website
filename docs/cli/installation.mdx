...
<!-- prettier-ignore-start -->
:::note
The disadvantage of a global installation is the difficulty of using third-party pipes, such as
the CompressPipe. If you wish to use more pipes, it is best to set up a project installation and
